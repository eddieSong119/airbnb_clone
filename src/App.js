...
export default function App() {
  return (
    <div>
      <Routes>
        <Route path='/' element={<><NavBar/><Modal/></>}>
          <Route exact path='/' element={<Home/>}/>
          <Route path='/search/:searchTerm' element={<Search/>}/>
          <Route path='/city/:cityName' element={<CityVenues/>}/>
          <Route path='venue/:vId' element={<VenuePage/>}/>
          <Route exact path='payment-success/:StripToken' element={<PaymentSuccess/>}/>
          <Route path='account/:email' element={<Account/>}>
            ...
            <Route path='reservations/change-pass' element={<ChangePassword/>}/>
          </Route>
        </Route>
      </Routes>
    </div>
