        ...
        <div className={`${Styles.LowerContainer} container-fluid`}>
            <div className='row'>
                <div className='col s12'>
                    <Cities cities={cities} header={`Cities matching your search: "${searchTerm}"`}/>
                </div>
                <div className='col s12'>
                    <Activities activities={activities} header={`Activities matching your search: "${searchTerm}"`}/>
                </div>
                <div className='col s12'>
                    <Venues venues={venues} header={`Venues matching your search: "${searchTerm}"`}/>
                </div>
            </div>
        </div>
      ) 
